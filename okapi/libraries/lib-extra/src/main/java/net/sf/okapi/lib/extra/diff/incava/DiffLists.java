...
public class DiffLists<Type> {
	 ...
	 */
	public DiffLists(Type[] a, Type[] b, Comparator<Type> comp) {
	 ...
	 */
	public DiffLists(Type[] a, Type[] b) {
		this(a, b, null);
	}
	 ...
	 */
	public DiffLists(List<Type> a, List<Type> b, Comparator<Type> comp) {
		this.a = a;
		this.b = b;
	 ...
	 */
	public DiffLists(List<Type> a, List<Type> b) {
		this(a, b, null);
	}
	...
	private Integer[] getLongestCommonSubsequences() {
		TreeMap<Integer, Integer> matches = (TreeMap<Integer, Integer>)getMatches();
