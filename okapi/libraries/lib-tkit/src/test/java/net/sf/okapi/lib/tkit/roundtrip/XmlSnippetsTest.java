...
public class XmlSnippetsTest {
	...
	public void setUp() {
		...
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/xml_wellformedConfiguration.yml");
		RoundTripUtils.path = TestUtil.getParentDir(this.getClass(), "/dummy.txt")+"test_xml_stream.json";
	}
	...
	public void testMultipleMETA() {
		...
		List<Event> events = roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters));
	...
	public void testAltInImg() {
		...
		assertEquals("Text1<img [#$tu2]/>.", tu.toString());		
	}
	...
	public void testExtractValueInInput() {
		...
		assertEquals("Text", tu.toString());
		tu = FilterTestDriver.getTextUnit(simplifiedEvents, 2);
		assertEquals("<input type=\"other\" [#$tu2]/>.", tu.toString());
	}
	...
	public void testLabelInOption() {
		...
		assertNotNull(tu);
		assertEquals("Text1", tu.toString());
		tu = FilterTestDriver.getTextUnit(simplifiedEvents, 3);
		assertNotNull(tu);
		assertEquals(".", tu.toString());
	}
	...
	public void testMETATag1() {
		...
		assertEquals(snippet, XmlStreamTestUtils.generateOutput(
				roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters)), snippet, locEN,
				xmlStreamFilter));
	}
	...
	public void testLang() {
		...
		assertEquals(snippet, XmlStreamTestUtils.generateOutput(
				roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters), locEN), snippet, locEN,
				xmlStreamFilter));
	}
	...
	public void testCdataSectionAsHTML() {
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/cdataAsHTML.yml");
	...
	public void testCdataSectionExtractionWithCondition () {
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/cdataWithConditions.yml");
		IFilterConfigurationMapper fcMapper = new FilterConfigurationMapper();
		fcMapper.addConfigurations("net.sf.okapi.filters.html.HtmlFilter");
		xmlStreamFilter.setFilterConfigurationMapper(fcMapper);
	...
	public void testEscapes() {
		...
		assertEquals(
				...
				XmlStreamTestUtils.generateOutput(
						roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters)),
	...
	public void testNewlineDetection() {
		...
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/xml_collapseWhitespaceOff.yml");
		assertEquals(snippet, XmlStreamTestUtils.generateOutput(
				roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters)), snippet, locEN,
				xmlStreamFilter));
	...
	public void testCodeFinder() {
		...
		URL originalParameters = parameters;
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/xml_withCodeFinderRules.yml");
	...
	public void testInlineAndExclude() {
		...
		ITextUnit tu = FilterTestDriver.getTextUnit(
				roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters)), 1);
	...
	public void testInlineAndExclude2() {
		URL originalParameters = parameters;
		parameters = net.sf.okapi.filters.xmlstream.XmlSnippetsTest.class.getResource("/test1.yml");
	...
	public void testXmlIdResname() {
		...
		tu = FilterTestDriver.getTextUnit(
				roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters)), 2);
	...
	public void testConditionalInlineWithAttribute() {
		...
		snippet = "<p>TEST: <image placement=\"break\" href=\"bike.gif\" alt=\"text in alt\"/> more text</p>";
		events = roundTripSerilaizedEvents(XmlStreamTestUtils.getEvents(snippet, xmlStreamFilter, parameters));
		tu1 = FilterTestDriver.getTextUnit(events, 1);
		tu2 = FilterTestDriver.getTextUnit(events, 2);
		tu3 = FilterTestDriver.getTextUnit(events, 3);
		assertEquals("text in alt", tu1.toString());
		assertEquals("TEST:", tu2.toString());
		assertEquals("more text", tu3.toString());
