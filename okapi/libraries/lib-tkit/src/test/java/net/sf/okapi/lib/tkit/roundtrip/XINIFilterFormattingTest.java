...
public class XINIFilterFormattingTest {
	...
	@Before
	public void setUp() {
		RoundTripUtils.path = TestUtil.getParentDir(this.getClass(), "/dummy.txt")+"test_xini.json";
	}
	...
	public void tagsBecomeCodes() {
		...
		ITextUnit tu2 = FilterTestDriver.getTextUnit(roundTripSerilaizedEvents(helper.toEvents(snippet)), 2);
