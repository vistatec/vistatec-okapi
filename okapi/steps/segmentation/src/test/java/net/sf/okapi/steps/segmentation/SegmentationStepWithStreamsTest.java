...
public class SegmentationStepWithStreamsTest {
	...
	@Before
	public void startUp() throws URISyntaxException, FileNotFoundException {
		...
		// let FileInputStream.finalize() close the streams below
		params.setSourceSrxStream(new FileInputStream(srxFile));
		params.setTargetSrxStream(new FileInputStream(srxFile));
