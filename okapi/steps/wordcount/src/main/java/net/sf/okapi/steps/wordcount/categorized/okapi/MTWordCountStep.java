...
public class MTWordCountStep extends AltAnnotationBasedCountStep implements CategoryHandler {
	
	public static final String METRIC = MatchType.MT.name(); 
	...
	public String getDescription() {
		return "Indicates a translation coming from an MT engine."
		+ " Expects: filter events. Sends back: filter events.";
	}

	@Override
	public String getName() {
		return "MT Word Count";
	}
