...
public class FuzzyUniqueIdMatchWordCountStep extends AltAnnotationBasedCountStep implements CategoryHandler {
	
	public static final String METRIC = MatchType.FUZZY_UNIQUE_ID.name(); 
	...
	public String getDescription() {
		return "Matches FUZZY and matches a unique id."
		+ " Expects: filter events. Sends back: filter events.";
	}

	@Override
	public String getName() {
		return "Fuzzy Unique Id Match Word Count";
	}
