...
public class ExactLocalContextMatchCharacterCountStep extends ExactLocalContextMatchWordCountStep {
	
	public static final String METRIC = MatchType.EXACT_LOCAL_CONTEXT.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Exact Local Context Match Character Count";
	}
