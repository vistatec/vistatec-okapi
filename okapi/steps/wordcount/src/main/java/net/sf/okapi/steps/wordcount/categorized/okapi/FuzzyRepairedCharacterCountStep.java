...
public class FuzzyRepairedCharacterCountStep extends FuzzyRepairedWordCountStep {
	
	public static final String METRIC = MatchType.FUZZY_REPAIRED.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Fuzzy Repaired Match Character Count";
	}
