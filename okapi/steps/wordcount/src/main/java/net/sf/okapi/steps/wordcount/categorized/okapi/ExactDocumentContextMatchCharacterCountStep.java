...
public class ExactDocumentContextMatchCharacterCountStep extends ExactDocumentContextMatchWordCountStep {
	
	public static final String METRIC = MatchType.EXACT_DOCUMENT_CONTEXT.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Exact Document Context Match Character Count";
	}
