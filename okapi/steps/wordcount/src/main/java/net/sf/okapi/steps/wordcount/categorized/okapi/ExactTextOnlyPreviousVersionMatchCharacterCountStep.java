...
public class ExactTextOnlyPreviousVersionMatchCharacterCountStep extends ExactTextOnlyPreviousVersionMatchWordCountStep {
	
	public static final String METRIC = MatchType.EXACT_TEXT_ONLY_PREVIOUS_VERSION.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Exact Text Only Previous Version Match Character Count";
	}
