...
public class ExactTextOnlyWordCountStep extends AltAnnotationBasedCountStep implements CategoryHandler {
	
	public static final String METRIC = MatchType.EXACT_TEXT_ONLY.name(); 
	...
	public String getDescription() {
		return "Matches text exactly, but there is a difference in one or more codes."
		+ " Expects: filter events. Sends back: filter events.";
	}

	@Override
	public String getName() {
		return "Exact Text Only Match Word Count";
	}

	@Override
	protected boolean accept(MatchType type) {
		return type == MatchType.EXACT_TEXT_ONLY;
	}
