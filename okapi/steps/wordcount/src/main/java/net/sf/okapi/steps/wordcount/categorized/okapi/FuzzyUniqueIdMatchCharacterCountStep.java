...
public class FuzzyUniqueIdMatchCharacterCountStep extends FuzzyUniqueIdMatchWordCountStep {
	
	public static final String METRIC = MatchType.FUZZY_UNIQUE_ID.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Fuzzy Unique Id Match Character Count";
	}
