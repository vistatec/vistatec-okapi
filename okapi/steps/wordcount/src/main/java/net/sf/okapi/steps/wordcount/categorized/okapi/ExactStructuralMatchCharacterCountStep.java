...
public class ExactStructuralMatchCharacterCountStep extends ExactStructuralMatchWordCountStep {
	
	public static final String METRIC = MatchType.EXACT_STRUCTURAL.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Exact Structural Match Character Count";
	}
