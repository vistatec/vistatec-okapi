...
public class ExactPreviousVersionMatchCharacterCountStep extends ExactPreviousVersionMatchWordCountStep {

	public static final String METRIC = MatchType.EXACT_PREVIOUS_VERSION.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Exact Previous Version Match Character Count";
	}
