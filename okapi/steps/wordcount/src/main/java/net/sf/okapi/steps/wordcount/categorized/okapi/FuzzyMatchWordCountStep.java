...
public class FuzzyMatchWordCountStep extends AltAnnotationBasedCountStep implements CategoryHandler {
	
	public static final String METRIC = MatchType.FUZZY.name(); 
	...
	public String getDescription() {
		return "Matches both text and/or codes partially."
