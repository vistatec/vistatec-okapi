...
public class FuzzyPreviousVersionMatchCharacterCountStep extends FuzzyPreviousVersionMatchWordCountStep {

	public static final String METRIC = MatchType.FUZZY_PREVIOUS_VERSION.name() + "_CHARACTERS"; 
	...
	public String getName() {
		return "Fuzzy Previous Version Match Character Count";
	}
