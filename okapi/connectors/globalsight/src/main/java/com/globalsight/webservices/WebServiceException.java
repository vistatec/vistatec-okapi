...
public class WebServiceException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    /**
     * Gets the message1 value for this WebServiceException.
     * 
     * @return message1
     */
    ...
    /**
     * Sets the message1 value for this WebServiceException.
     * 
     * @param message1
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.globalsight.com", "WebServiceException"));
