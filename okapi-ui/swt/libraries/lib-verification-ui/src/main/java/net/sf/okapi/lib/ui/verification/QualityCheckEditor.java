...
public class QualityCheckEditor implements IQualityCheckEditor {
	 ...
	 * Either {@link #edit(boolean)} or
	 * {@link #initialize(Object, boolean, IHelp, IFilterConfigurationMapper, QualityCheckSession)} must be called
	 * afterward. 
	 */
	 ...
	 * @param paramSession an optional session to use (null to use one created internally)
	 */
	@Override
	...
	private void createContent () {
		...
		cbTypes.add("Text length"); // Length-related issues
		...
		cbTypes.add("Other issues"); // Other (e.g. type is null)
