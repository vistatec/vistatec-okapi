...
public class Editor implements IParametersEditor {
		...
		boolean readOnly)
	{
		...
		includeMsgCtxtInNote = new Button(cmpTmp, SWT.CHECK);
		includeMsgCtxtInNote.setText(Res.getString("includeMsgCtxtInNote"));
...
//options go there
	...
	private void setData () {
		...
		includeMsgCtxtInNote.setSelection(params.getIncludeMsgContextInNote());
	...
	private boolean saveData () {
		...
		params.setIncludeMsgContextInNote(includeMsgCtxtInNote.getSelection());
