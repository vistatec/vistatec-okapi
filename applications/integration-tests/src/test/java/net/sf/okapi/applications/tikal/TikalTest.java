...
public class TikalTest {
	...
	public void setUp () throws URISyntaxException {
		...
		javaTikal = new String[] { "java", "-jar", libDir + "tikal.jar" };
	}
    ...
    public void testExtractMergeDTD () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr dtdtest.dtd -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("dtdtest.dtd.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr dtdtest.dtd.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("dtdtest.out.dtd"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr dtdtest.dtd -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("dtdtest.dtd.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr dtdtest.dtd.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("dtdtest.out.dtd", "windows-1252"));
    }
    ...
    public void testExtractMergeHTML () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr htmltest.html -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("htmltest.html.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr htmltest.html.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("htmltest.out.html"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr htmltest.html -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("htmltest.html.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr htmltest.html.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("htmltest.out.html", "windows-1252"));
    }
    ...
    public void testExtractMergeJSON () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr jsontest.json -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("jsontest.json.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr jsontest.json.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("jsontest.out.json"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr jsontest.json -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("jsontest.json.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr jsontest.json.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("jsontest.out.json", "windows-1252"));
    }
    ...
    public void testExtractMergePO () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr potest.po -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest.po.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr potest.po.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("potest.out.po"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr potest.po -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest.po.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr potest.po.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest.out.po", "windows-1252"));
    }
    ...
    public void testExtractMergePOMono () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr potest-mono.po -fc okf_po-monolingual -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest-mono.po.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr potest-mono.po.xlf -fc okf_po-monolingual -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("potest-mono.out.po"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr potest-mono.po -fc okf_po-monolingual -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest-mono.po.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr potest-mono.po.xlf -fc okf_po-monolingual -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("potest-mono.out.po", "windows-1252"));
    }
    ...
    public void testExtractMergeProperties () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr proptest.properties -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.properties.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr proptest.properties.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("proptest.out.properties"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr proptest.properties -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.properties.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr proptest.properties.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.out.properties", "windows-1252"));
    }
    ...
    public void testExtractMergePropertiesNoEscapes () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr proptest.properties -fc okf_properties-outputNotEscaped -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.properties.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr proptest.properties.xlf -fc okf_properties-outputNotEscaped -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("proptest.out.noesc.properties"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr proptest.properties -fc okf_properties-outputNotEscaped -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.properties.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr proptest.properties.xlf -fc okf_properties-outputNotEscaped -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("proptest.out.properties", "proptest.out.noesc.properties", "windows-1252"));
    }
    ...
    public void testExtractMergeODT () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr odttest.odt -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("odttest.odt.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr odttest.odt.xlf"));
    	...
    	assertTrue(deleteOutputFile("odttest.out.odt"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr odttest.odt -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("odttest.odt.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr odttest.odt.xlf"));
    	assertTrue("File different from gold", compareZipWithGoldFile("odttest.out.odt"));
    }
	...
	public void testExtractMergeODS () throws IOException, InterruptedException {
		// Delete previous output
		assertTrue(deleteOutputFile("odstest.ods.xlf"));
		assertTrue(deleteOutputFile("odstest.out.ods"));
		// Extract
		assertEquals(0, runTikal("-x1 -sl en -tl fr odstest.ods -ie windows-1252"));
		assertTrue("File different from gold", compareWithGoldFile("odstest.ods.xlf", "UTF-8"));
		// Merge
		assertEquals(0, runTikal("-m1 -sl en -tl fr odstest.ods.xlf"));
		assertTrue("File different from gold", compareZipWithGoldFile("odstest.out.ods"));

		// Delete previous output
		assertTrue(deleteOutputFile("odstest.ods.xlf"));
		assertTrue(deleteOutputFile("odstest.out.ods"));
		// Extract
		assertEquals(0, runTikal("-x2 -sl en -tl fr odstest.ods -ie windows-1252"));
		assertTrue("File different from gold", compareWithGoldFile("odstest.ods.xlf", "UTF-8"));
		// Merge
		assertEquals(0, runTikal("-m2 -sl en -tl fr odstest.ods.xlf"));
		assertTrue("File different from gold", compareZipWithGoldFile("odstest.out.ods"));
	}
    ...
    public void testExtractMergeDOCX () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr docxtest.docx -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("docxtest.docx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr docxtest.docx.xlf"));
    	assertTrue("File different from gold", compareZipWithGoldFile("docxtest.out.docx"));

    	/* OpenXML no longer supports JSON skeleton
    	// Delete previous output
    	assertTrue(deleteOutputFile("docxtest.docx.xlf"));
    	assertTrue(deleteOutputFile("docxtest.out.docx"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr docxtest.docx -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("docxtest.docx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr docxtest.docx.xlf"));
    	assertTrue("File different from gold", compareZipWithGoldFile("docxtest.out.docx"));
    	*/
    }
    ...
    public void testExtractSegmentMergeDOCX () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr docxsegtest.docx -seg -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("docxsegtest.docx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr docxsegtest.docx.xlf"));
    	...
    	assertTrue(deleteOutputFile("docxsegtest.out.docx"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr docxsegtest.docx -seg -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("docxsegtest.docx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr docxsegtest.docx.xlf"));
    	assertTrue("File different from gold", compareZipWithGoldFile("docxsegtest.out.docx"));
    	*/
    }
    ...
    public void testExtractMergeTMX () throws IOException, InterruptedException {
    	...
    	assertTrue(deleteOutputFile("tmxtest-attributes.out.tmx"));
    	// Extract
    	assertEquals(0, runTikal("-x1 tmxtest-attributes.tmx -sl EN-US -tl FR-FR -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("tmxtest-attributes.tmx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 tmxtest-attributes.tmx.xlf -sl EN-US -tl FR-FR -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("tmxtest-attributes.out.tmx"));
    	// Extract
    	assertEquals(0, runTikal("-x2 tmxtest-attributes.tmx -sl EN-US -tl FR-FR -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("tmxtest-attributes.tmx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 tmxtest-attributes.tmx.xlf -sl EN-US -tl FR-FR -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("tmxtest-attributes.out.tmx", "windows-1252"));
    }
    ...
    public void testExtractMergeIDML () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr idmltest.idml -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("idmltest.idml.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr idmltest.idml.xlf"));
...
//    	assertTrue(deleteOutputFile("idmltest.out.idml"));
//    	// Extract
//    	assertEquals(0, runTikal("-x2 -sl en -tl fr idmltest.idml -ie UTF-8"));
//    	assertTrue("File different from gold", compareWithGoldFile("idmltest.idml.xlf", "UTF-8"));
//    	// Merge
//    	assertEquals(0, runTikal("-m2 -sl en -tl fr idmltest.idml.xlf"));
////		ZipXMLFileCompare compare = new ZipXMLFileCompare(); 
////		assertTrue(compare.compareFiles(root+"/idmltest.out.idml", root+"/gold/idmltest.out.idml"));
//		assertTrue("File different from gold", compareZipWithGoldFile("idmltest.out.idml"));
    }
    ...
    public void testExtractMergeTS () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr tstest.ts -sl EN-US -tl FR-FR -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("tstest.ts.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr tstest.ts.xlf -sl EN-US -tl FR-FR -oe UTF-8"));
    	...
    	assertTrue(deleteOutputFile("tstest.out.ts"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr tstest.ts -sl EN-US -tl FR-FR -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("tstest.ts.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr tstest.ts.xlf -sl EN-US -tl FR-FR -oe UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("tstest.out.ts", "windows-1252"));
    }
    ...
    public void testExtractMergeXLIFF () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr xlifftest.xlf"));
    	assertTrue("File different from gold", compareWithGoldFile("xlifftest.xlf.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr xlifftest.xlf.xlf -oe windows-1252"));
    	...
    	assertTrue(deleteOutputFile("xlifftest.out.xlf"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr xlifftest.xlf"));
    	assertTrue("File different from gold", compareWithGoldFile("xlifftest.xlf.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr xlifftest.xlf.xlf -oe windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("xlifftest.out.xlf", "UTF-8"));
    }
    ...
    public void testExtractMergeXML () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr xmltest1.xml -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest1.xml.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr xmltest1.xml.xlf -oe UTF-8"));
    	...
    	assertTrue(deleteOutputFile("xmltest1.out.xml"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr xmltest1.xml -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest1.xml.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr xmltest1.xml.xlf -oe UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest1.out.xml", "UTF-8"));
    }
    ...
    public void testExtractMergeStreamedXML () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr xmltest3.xml -fc okf_xmlstream -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest3.xml.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr xmltest3.xml.xlf -fc okf_xmlstream -oe UTF-8"));
    	...
    	assertTrue(deleteOutputFile("xmltest3.out.xml"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr xmltest3.xml -fc okf_xmlstream -ie UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest3.xml.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr xmltest3.xml.xlf -fc okf_xmlstream -oe UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("xmltest3.out.xml", "UTF-8"));
    }
    ...
    public void testExtractMergeTSV () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr tsvtest.txt -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("tsvtest.txt.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr tsvtest.txt.xlf -oe UTF-8"));
    	...
    	assertTrue(deleteOutputFile("tsvtest.out.txt"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr tsvtest.txt -ie windows-1252"));
    	assertTrue("File different from gold", compareWithGoldFile("tsvtest.txt.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr tsvtest.txt.xlf -oe UTF-8"));
    	assertTrue("File different from gold", compareWithGoldFile("tsvtest.out.txt", "UTF-8"));
    }
    ...
    public void testExtractMergeRESX () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr resxtest.resx")); // Auto-assign okf_xml-resx
    	assertTrue("File different from gold", compareWithGoldFile("resxtest.resx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr resxtest.resx.xlf -ie windows-1252")); // Auto-assign okf_xml-resx
    	...
    	assertTrue(deleteOutputFile("resxtest.out.resx"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr resxtest.resx")); // Auto-assign okf_xml-resx
    	assertTrue("File different from gold", compareWithGoldFile("resxtest.resx.xlf", "UTF-8"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr resxtest.resx.xlf -ie windows-1252")); // Auto-assign okf_xml-resx
    	assertTrue("File different from gold", compareWithGoldFile("resxtest.out.resx", "windows-1252"));
    }
    ...
    public void testExtractMergeSRT () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr srttest.srt -ie windows-1252")); // Auto-assign okf_regex-srt
    	assertTrue("File different from gold", compareWithGoldFile("srttest.srt.xlf", "windows-1252"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr srttest.srt.xlf -ie UTF-8")); // Auto-assign okf_regex-srt
    	...
    	assertTrue(deleteOutputFile("srttest.out.srt"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr srttest.srt -ie windows-1252")); // Auto-assign okf_regex-srt
    	assertTrue("File different from gold", compareWithGoldFile("srttest.srt.xlf", "windows-1252"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr srttest.srt.xlf -ie UTF-8")); // Auto-assign okf_regex-srt
    	assertTrue("File different from gold", compareWithGoldFile("srttest.out.srt", "UTF-8"));
    }
    ...
    public void testExtractMergeYAML () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr yamltest.yml -ie UTF-8")); // Auto-assign okf_railsyaml
    	assertTrue("File different from gold", compareWithGoldFile("yamltest.yml.xlf", "windows-1252"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr yamltest.yml.xlf -ie UTF-8")); // Auto-assign okf_railsyaml
...
//    	assertTrue(deleteOutputFile("yamltest.out.yml"));
//    	// Extract
//    	assertEquals(0, runTikal("-x2 -sl en -tl fr yamltest.yml -ie UTF-8")); // Auto-assign okf_railsyaml
//    	assertTrue("File different from gold", compareWithGoldFile("yamltest.yml.xlf", "windows-1252"));
//    	// Merge
//    	assertEquals(0, runTikal("-m2 -sl en -tl fr yamltest.yml.xlf -ie UTF-8")); // Auto-assign okf_railsyaml
//    	assertTrue("File different from gold", compareWithGoldFile("yamltest.out.yml", "UTF-8"));
    }
    ...
    public void testExtractMergeVersified () throws IOException, InterruptedException {
    	...
    	// Extract
    	assertEquals(0, runTikal("-x1 -sl en -tl fr versifiedtest.txt -ie UTF-8 -fc okf_versifiedtxt"));
    	assertTrue("File different from gold", compareWithGoldFile("versifiedtest.txt.xlf", "windows-1252"));
    	// Merge
    	assertEquals(0, runTikal("-m1 -sl en -tl fr versifiedtest.txt.xlf -ie UTF-8 -fc okf_versifiedtxt"));
    	...
    	assertTrue(deleteOutputFile("versifiedtest.out.txt"));
    	// Extract
    	assertEquals(0, runTikal("-x2 -sl en -tl fr versifiedtest.txt -ie UTF-8 -fc okf_versifiedtxt"));
    	assertTrue("File different from gold", compareWithGoldFile("versifiedtest.txt.xlf", "windows-1252"));
    	// Merge
    	assertEquals(0, runTikal("-m2 -sl en -tl fr versifiedtest.txt.xlf -ie UTF-8 -fc okf_versifiedtxt"));
    	assertTrue("File different from gold", compareWithGoldFile("versifiedtest.out.txt", "UTF-8"));
    }
    ...
    public void zz1TestQuerySeveralConnectors () throws IOException, InterruptedException {
    	...
    	if ( res != 0 ) {
    		logger.error("\n=============== WARNING ===============");
    		logger.error("The test of querying several translation resources failed.");
    		logger.error("This may be due to connection issues, or to real API problems with one of the connectors. Please check.");
    		logger.error("=======================================");
    	}
    }
    ...
    public void zz2TestTranslateXML () throws IOException, InterruptedException {
    	...
    	// Changed to use Amagama instead of Apertium
    	//int res = runTikal("-t -sl en -tl eo xmltest2.xml -apertium myApertium.cfg -oe UTF-8 -trace");
    	// Note that Amagama uses an HTTPS URL and needs the proper security certificate 
    	int res = runTikal("-t xmltest2.xml -sl en -tl af -tt -trace -oe UTF-8");
    	if ( res == 0 ) {
    		assertTrue("File different from gold", compareWithGoldFile("xmltest2.out.xml", "UTF-8"));
    	}
    	else {
    		logger.error("\n=============== WARNING ===============");
    		logger.error("This test did not pass because the translation resources failed.");
    		logger.error("This may be due to connection issues, or to real API problems with one of the connectors. Please check.");
    		logger.error("=======================================");
    	}
    }
    ...
    private boolean compareZipWithGoldFile (String outputBase) {
    	...
    	logger.trace("Zipped file comparison");
    	logger.trace("Output File: "+outputPath);
    	logger.trace("Gold File: "+goldPath+"\n");
    ...
    private int runTikal (String extraArgs) throws IOException, InterruptedException {
    	...
    	logger.info("");
    	logger.info("cmd>===============================================================================");
    	logger.info("cmd>"+args+" "+((extraArgs==null) ? "" : " "+extraArgs));
    	Process p = Runtime.getRuntime().exec(args.toArray(new String[0]), null, rootAsFile);
